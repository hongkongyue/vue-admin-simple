  ...
  <div>
    ...
    <div class="table_box">
      <el-table id="tabledata_show" :data="tableData" style="width: 100%" :border='true' size="mini" :stripe="true">
        ...
        <el-table-column prop="data" label="订单留存市场(天)" align="center"></el-table-column>
...
<script>
import searchSellGoldOrder from '../../components/search/searchSellGoldOrder.vue'
