  ...
  <div>
    ...
    <div class="table_box">
      <el-table id="tabledata_show" v-loading="tableLoading" :data="tableData" style="width: 100%" :border='true' size="mini" :stripe="true">
        ...
        <el-table-column prop="data" label="资讯名称" align="center"></el-table-column>
    ...
    <!-- dialog新增资讯 -->
    <el-dialog v-cloak class="dialog_order_check" title="新增资讯" top="10vh" :visible.sync="dialogAdd" width="1000px">
      <edit-inform></edit-inform>
    </el-dialog>
    

    <!-- dialog编辑资讯 -->
    <el-dialog v-cloak class="dialog_order_check" title="编辑资讯" :detail="itemDetail" top="10vh" :visible.sync="dialogEdit" width="1000px">
      <edit-inform type="edit" :detail="itemDetail"></edit-inform>
    </el-dialog>

    <!-- 资讯详情 -->
    <el-dialog class="detail_dialog" title="资讯详情" top="10vh" :visible.sync="dialogDetail" width="1000px">
...
import searchInform from "../../components/search/searchNews.vue";
import detailComponent from "../../components/detail/informDetail.vue";
import editInform from "../../components/addAndEdit/editNews.vue";
