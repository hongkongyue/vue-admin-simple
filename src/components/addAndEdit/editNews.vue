    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      <section>
					...
					<div class="con">
						<el-row :gutter="10">
							<el-col :span="8">
								<el-form-item label="资讯名称" prop="input1">
										<el-input v-model="ruleForm.input1" size="small" placeholder="请输入资讯名称"></el-input>
								</el-form-item>
							</el-col>
							<el-col :span="8">
								<el-form-item label="资讯来源" prop="input1">
										<el-input v-model="ruleForm.input2" size="small" placeholder="请输入资讯来源"></el-input>
								</el-form-item>
							</el-col>
							<el-col :span="8">
								<el-form-item label="作者" prop="input1">
										<el-input v-model="ruleForm.input6" size="small" placeholder="请输入作者"></el-input>
								</el-form-item>
							</el-col>
						</el-row>
      ...
      <el-form-item label="备注" >
        <el-input v-model="ruleForm.input4" placeholder="请输入备注" type="textarea" :autosize="{ minRows: 2, maxRows: 4}"></el-input>
      </el-form-item>
