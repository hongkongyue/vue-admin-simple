<template>
  <div id="searchUser" class="search">
    ...
    <el-row :gutter="20">
      <el-col :span="4">
        <el-input placeholder="门店名称" v-model="formData.input1" type="text" size="small" clearable></el-input>
      </el-col>
      <el-col :span="4">
        <el-select v-model="formData.input3" size="small" style="width:100%;" filterable remote :remote-method="remoteMethod" :loading="selectLoading" placeholder="所属商家-请选择">
          <el-option
